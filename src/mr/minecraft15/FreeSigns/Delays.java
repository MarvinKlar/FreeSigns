...
public class Delays {
	...
	public static String getTime(long seconds) {
		...
		String secStr = (sec != 0) ? sec + " second" + ((sec == 1) ? "" : "s") : null, minStr = (min != 0) ? min + " minute" + ((min == 1) ? "" : "s") : null, hStr = (h != 0) ? h + " hour" + ((h == 1) ? "" : "s") : null, dStr = (d != 0) ? d + " day" + ((d == 1) ? "" : "s") : null, wStr = (w != 0) ? w + " week" + ((w == 1) ? "" : "s") : null, mStr = (m != 0) ? m + " month" + ((m == 1) ? "" : "s") : null, yStr = (y != 0) ? y + " year" + ((y == 1) ? "" : "s") : null;
